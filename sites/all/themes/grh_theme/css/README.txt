...
To use these stylesheets, rename the files and grh_theme with the name of your theme.
...
grh_theme-alpha-default-narrow.css  
...
grh_theme-alpha-default-normal.css
...
grh_theme-alpha-default-wide.css
